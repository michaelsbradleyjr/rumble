...
(def account-2 {:accountID account-1-id
                :password password
                :paths ["m/44'/60'/0'/0"
                        "m/43'/60'/1581'"
                        "m/43'/60'/1581'/0'/0"
...
(def multi-account-data {:name "Delectable Overjoyed Nauplius"
                         :address ((first derived-addresses) "address")
                         :photo-path photo-path
                         :key-uid ((first derived-addresses) "keyUid")
                         :keycard-pairing nil})

(def multi-account-data-json (json/write-str multi-account-data))

(def networks [{:id "testnet_rpc"
...
(def settings {:key-uid ((first derived-addresses) "keyUid")
...
(def settings-json (json/write-str settings))

(def accounts-data [{:public-key ((derived-accounts "m/44'/60'/0'/0/0") "publicKey")
...
(def accounts-data-json (json/write-str accounts-data))

(def boot-nodes ["enode://23d0740b11919358625d79d4cac7d50a34d79e9c69e16831c5c70573757a1f5d7d884510bc595d7ee4da3c1508adf87bbc9e9260d804ef03f8c1e37f2fb2fc69@47.52.106.107:443"
...
(def rendezvous-nodes ["/ip4/34.70.75.208/tcp/30703/ethv4/16Uiu2HAm6ZsERLx2BwVD2UM9SVPnnMU6NBycG8XPtu8qKys5awsU"
...
(def static-nodes ["enode://887cbd92d95afc2c5f1e227356314a53d3d18855880ac0509e0c0870362aee03939d4074e6ad31365915af41d34320b5094bfcc12a67c381788cd7298d06c875@178.128.141.0:443"
...
(def trusted-mail-servers ["enode://2c8de3cbb27a3d30cbb5b3e003bc722b126f5aef82e2052aaef032ca94e0c7ad219e533ba88c70585ebd802de206693255335b100307645ab5170e88620d2a81@47.244.221.14:443"
...
(def final-config {:BrowsersConfig {:Enabled true}
